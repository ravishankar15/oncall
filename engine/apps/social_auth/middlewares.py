...
from apps.social_auth.exceptions import InstallMultiRegionSlackException, UserLoginOAuth2MattermostException
    ...
    def process_exception(self, request, exception):
        ...
        if isinstance(exception, exceptions.AuthCanceled):
            ...
            url_to_redirect = urljoin(
                ...
                f"{redirect_to}?tab=ChatOps&chatOpsTab=Mattermost&mattermost_error={LOGIN_ERROR}",
            )
            return redirect(url_to_redirect)
